...
Проект реализован с учетом специфики русскоязычных текстов и ориентирован на обработку новостных статей от российских СМИ. Данный инструмент может быть полезен для быстрого получения сжатых версий новостных статей, что упрощает их анализ и восприятие.
...
![Вес готовой модели до обучения](https://www.example.com/image.jpg)
![Вес модели после дообучения](https://www.example.com/image.jpg)
