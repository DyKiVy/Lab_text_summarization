...
def train(
    ...
    for epoch in range(num_epochs):
        model.train()
        for batch in tqdm(gen_batch(train_records, batch_size), desc=f"Epoch {epoch + 1}/{num_epochs}"):
